...
export default function Login() {
    ...
    useEffect(() => {
        ...
        if (browserInfo.isFeishu && (!AreCookiesValid(cookies)) && !code) {
            ...
            window.location.href = "https://open.feishu.cn/open-apis/authen/v1/authorize?app_id=cli_a5e56060a07ad00c&amp;redirect_uri=http://127.0.0.1:5173/#/callback/feishuLogin";
        }
        else if (code) {
            // 重定向到 FeishuLogin 路由
